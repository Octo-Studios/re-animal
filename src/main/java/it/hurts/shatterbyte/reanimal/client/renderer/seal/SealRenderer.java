package it.hurts.shatterbyte.reanimal.client.renderer.seal;

import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.math.Axis;
import it.hurts.shatterbyte.reanimal.client.model.seal.SealModel;
...
public class SealRenderer extends GeoEntityRenderer<SealEntity> {
    ...
    @Override
    public void scaleModelForRender(float widthScale, float heightScale, PoseStack poseStack, SealEntity animatable, BakedGeoModel model, boolean isReRender, float partialTick, int packedLight, int packedOverlay) {
    ...
    @Override
    protected void applyRotations(SealEntity entity, PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTick, float scale) {
