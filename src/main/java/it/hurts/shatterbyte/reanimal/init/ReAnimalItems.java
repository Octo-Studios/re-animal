...
public class ReAnimalItems {
    ...
    public static final DeferredHolder<Item, Item> COOKED_HEDGEHOG_MEAT = ITEMS.register("cooked_hedgehog_meat", () -> new Item(new Item.Properties().food(new FoodProperties(5, 0.6F, false, 1.6F, Optional.empty(), List.of()))));
    public static final DeferredHolder<Item, Item> RAW_CAPYBARA_MEAT = ITEMS.register("raw_capybara_meat", () -> new Item(new Item.Properties().food(new FoodProperties(4, 0.3F, false, 1.6F, Optional.empty(), List.of()))));
    public static final DeferredHolder<Item, Item> COOKED_CAPYBARA_MEAT = ITEMS.register("cooked_capybara_meat", () -> new Item(new Item.Properties().food(new FoodProperties(8, 0.8F, false, 1.6F, Optional.empty(), List.of()))));
    public static final DeferredHolder<Item, Item> RAW_OSTRICH_MEAT = ITEMS.register("raw_ostrich_meat", () -> new Item(new Item.Properties().food(new FoodProperties(4, 0.35F, false, 1.6F, Optional.empty(), List.of()))));
    ...
    public static final DeferredHolder<Item, Item> COOKED_HIPPOPOTAMUS_MEAT = ITEMS.register("cooked_hippopotamus_meat", () -> new Item(new Item.Properties().food(new FoodProperties(10, 0.9F, false, 1.6F, Optional.empty(), List.of()))));
    public static final DeferredHolder<Item, Item> RAW_GIRAFFE_MEAT = ITEMS.register("raw_giraffe_meat", () -> new Item(new Item.Properties().food(new FoodProperties(5, 0.4F, false, 1.6F, Optional.empty(), List.of()))));
    public static final DeferredHolder<Item, Item> COOKED_GIRAFFE_MEAT = ITEMS.register("cooked_giraffe_meat", () -> new Item(new Item.Properties().food(new FoodProperties(9, 0.9F, false, 1.6F, Optional.empty(), List.of()))));
}
