...
public class OstrichAI {
    private static final ImmutableList<SensorType<? extends Sensor<? super OstrichEntity>>> SENSOR_TYPES = ImmutableList.of(
            SensorType.NEAREST_LIVING_ENTITIES,
            SensorType.HURT_BY,
            ReAnimalSensorTypes.OSTRICH_TEMPTATIONS.get(),
    ...
    public static Brain.Provider<OstrichEntity> brainProvider() {
    ...
    private static void initCoreActivity(Brain<OstrichEntity> brain) {
        brain.addActivity(
                Activity.CORE,
                0,
                ImmutableList.of(
    ...
    private static void initIdleActivity(Brain<OstrichEntity> brain) {
        brain.addActivity(
                Activity.IDLE,
                ImmutableList.of(
                        Pair.of(0, SetEntityLookTargetSometimes.create(EntityType.PLAYER, 6F, UniformInt.of(30, 60))),
                        Pair.of(1, new AnimalMakeLove(ReAnimalEntities.OSTRICH.get(), 1F, 1)),
                        Pair.of(
                                2,
                                new RunOne<>(
                                        ImmutableList.of(
    ...
    private static void initPanicActivity(Brain<OstrichEntity> brain) {
    ...
    public static void updateActivity(OstrichEntity entity) {
        entity.getBrain().setActiveActivityToFirstValid(ImmutableList.of(Activity.PANIC, Activity.IDLE));
    }

    public static Predicate<ItemStack> getTemptations() {
        return stack -> stack.is(ReAnimalTags.Items.OSTRICH_FOOD);
    }
}
